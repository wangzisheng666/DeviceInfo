...
public class Build_device_info {
     ...
     *标签Build.TAGS
     */
    public static String getBuildTags(){return Build.TAGS;}
    /**
     * cpu架构 Build.CPU_ABI
     */
    public static String getCPU_ABI(){return Build.CPU_ABI;}
    /**
     * cpu2架构 Build.CPU_ABI2
     */
    public static String getCPU_ABI2(){return Build.CPU_ABI2;}
    /**
     * android sdk版本Build.VERSION.SDK
     */
    public static String getBuildVERSIONSDK(){return Build.VERSION.SDK;}
    /**
     * Android SDK版本号Build.VERSION.SDK_INT
     */
    public static int getBuildVERSIONSDK_INT(){return Build.VERSION.SDK_INT;}
    /**
     * 驱动Build.DEVICE
     */
    public static String getBuilddevice(){return Build.DEVICE;}
    /**
     ...
     * 编译时间TIME Build.TIME
     */
    public static long getTime(){return Build.TIME;}
    /**
     * RADIO Build.RADIO
     */
    public static String getRadio(){return Build.RADIO;}
    /**
     * 序列号（SERIAL）Build.SERIAL
     */
    public static String getSerial(){return Build.SERIAL;}
    /**
     * bootloader
     */
