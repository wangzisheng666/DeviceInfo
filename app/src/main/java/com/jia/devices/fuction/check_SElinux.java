...
import static com.jia.devices.core.webview.AgentWebFragment.TAG;

import android.text.TextUtils;
import android.util.Log;

import com.jia.devices.utils.Shell_Util;
...
public class check_SElinux {
    ...
    public static String SElinux() {
        ...
        String a2 = String.valueOf(Shell_Util.shell("getenforce"));
